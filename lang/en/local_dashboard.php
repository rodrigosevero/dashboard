...
$string['goto_mycourses'] = 'Open My courses';
$string['upcoming'] = 'Upcoming';
$string['noevents'] = 'No events for the next days.';
$string['nocourses'] = 'No active enrolments found.';
$string['messages'] = 'Messages';
$string['unread_hint'] = 'Unread conversations.';
$string['announcements'] = 'Important information & notices';
$string['noann'] = 'No announcements yet.';
$string['important_info'] = 'Important information';
$string['announcementsfallback'] = 'Announcements fallback message';
$string['announcementsfallback_desc'] = 'If no Site News forum is found, show this message on the announcements card.';
...
$string['supportwhatsapp'] = 'Support WhatsApp URL';
$string['supportwhatsapp_desc'] = 'Full WhatsApp link, e.g. https://wa.me/55XXXXXXXXXXX';
$string['supporthelpdesk'] = 'Helpdesk portal URL';
$string['supporthelpdesk_desc'] = 'URL of your ticketing/helpdesk portal.';
$string['supporthours'] = 'Support hours';
$string['hours'] = 'Hours';
